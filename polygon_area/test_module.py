...
class UnitTests(unittest.TestCase):
    ...
    def test_subclass(self):
        actual = issubclass(Polygon_area_calculator.Square, Polygon_area_calculator.Rectangle)
        expected = True
    ...
    def test_square_is_square_and_rectangle(self):
        actual = isinstance(self.sq, Polygon_area_calculator.Square) and isinstance(self.sq, Polygon_area_calculator.Rectangle)
        expected = True
